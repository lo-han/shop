...
return [
    ...
    'contribute'     => [
        ...
        'controller' => [
            ...
            //后台管理控制器
            'admin/Login','admin/Book','admin/Section','admin/Category','admin/Place','admin/User','admin/News','admin/Admin','admin/Setting','admin/Connector','admin/connector/Yuedu',
            //API控制器
            'api/Book','api/Section',
        ],
        'model'      => ['User','Admin','Book','BookSection','Category','Place','Tag','TagRelation','TagRelation','PlaceRelation','News','Advert','Mark','Connector'],
        'view'       => [
            //错误页面模板
            'error/404',
            //展示页面模板
