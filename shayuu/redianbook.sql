...
) ENGINE=MyISAM AUTO_INCREMENT=5 DEFAULT CHARSET=utf8 COMMENT='制作人用户表格';

INSERT INTO `admin` VALUES ('1', 'admin', 'admin', '2326ef242493e5c8973f6b7cd3dcb3be', '', '', '', '', '', '', '', '', '1', '1', '', '0', '0');
...
) ENGINE=MyISAM AUTO_INCREMENT=41 DEFAULT CHARSET=utf8 COMMENT='书本表格';
...
) ENGINE=MyISAM AUTO_INCREMENT=7705 DEFAULT CHARSET=utf8 COMMENT='书本章节表格';
...
) ENGINE=MyISAM AUTO_INCREMENT=10 DEFAULT CHARSET=utf8 COMMENT='类型';
...
) ENGINE=MyISAM AUTO_INCREMENT=10 DEFAULT CHARSET=utf8 COMMENT='推介表格';
...
CREATE TABLE `news` (
  ...
  FULLTEXT KEY `table_book_index_title` (`title`)
) ENGINE=MyISAM AUTO_INCREMENT=8 DEFAULT CHARSET=utf8 COMMENT='资讯表格';
...
) ENGINE=MyISAM AUTO_INCREMENT=15 DEFAULT CHARSET=utf8 COMMENT='分销网站';
...
) ENGINE=MyISAM AUTO_INCREMENT=374 DEFAULT CHARSET=utf8 COMMENT='分销商索引';
...
) ENGINE=MyISAM AUTO_INCREMENT=71 DEFAULT CHARSET=utf8 COMMENT='标签库';
...
) ENGINE=MyISAM AUTO_INCREMENT=1151 DEFAULT CHARSET=utf8 COMMENT='标签索引';
...
) ENGINE=MyISAM AUTO_INCREMENT=45 DEFAULT CHARSET=utf8 COMMENT='用户个人信息表';
