...
Source Server         : 101.132.121.5
Source Server Version : 50722
Source Host           : 101.132.121.5:3306
...
CREATE TABLE `admin` (
  ...
  `role` tinyint(4) NOT NULL COMMENT '用户的角色分配',
...
) ENGINE=MyISAM AUTO_INCREMENT=2 DEFAULT CHARSET=utf8 COMMENT='制作人用户表格';

INSERT INTO `admin` VALUES ('1', 'admin', 'admin', 'd91e6eee299012230f4a9cc08ec7d684', '', '', '', '', '', '', '', '', '1', '1', '', '0', '0');
...
) ENGINE=MyISAM AUTO_INCREMENT=55 DEFAULT CHARSET=utf8 COMMENT='书本表格';
...
) ENGINE=MyISAM AUTO_INCREMENT=27 DEFAULT CHARSET=utf8 COMMENT='书籍推介表格';
...
) ENGINE=MyISAM AUTO_INCREMENT=4525 DEFAULT CHARSET=utf8 COMMENT='书本章节表格';
...
) ENGINE=MyISAM AUTO_INCREMENT=6 DEFAULT CHARSET=utf8 COMMENT='类型';
...
) ENGINE=MyISAM AUTO_INCREMENT=3 DEFAULT CHARSET=utf8 COMMENT='分销网站';
...
) ENGINE=MyISAM AUTO_INCREMENT=69 DEFAULT CHARSET=utf8 COMMENT='分销商索引';
...
) ENGINE=MyISAM AUTO_INCREMENT=12 DEFAULT CHARSET=utf8 COMMENT='标签库';
...
) ENGINE=MyISAM AUTO_INCREMENT=93 DEFAULT CHARSET=utf8 COMMENT='标签索引';
...
) ENGINE=MyISAM AUTO_INCREMENT=52 DEFAULT CHARSET=utf8 COMMENT='用户个人信息表';
